classdef LASConverter
    methods(Static)
        ...
        function LASData2Bytes_Octree(xyzClass, lasName, pointsPerFile, voxelName)
            ...
            if length(xyzClass) < pointsPerFile
                ...
                [pc1, pc2, pc3, pc4, pc5, pc6, pc7, pc8] = LASConverter.splitInOctree(xyzClass); 
                voxels = {pc1, pc2, pc3, pc4, pc5, pc6, pc7, pc8};
                
                for i = 1:length(voxels)
                    newVoxelName = sprintf("%s_%d", voxelName, i);
                    LASConverter.LASData2Bytes_Octree(xyzClass(voxels{i}, :), lasName, pointsPerFile, newVoxelName)
                end
